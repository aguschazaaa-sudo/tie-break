...
class ReservationRepository {
  ...
  /// Obtiene las reservas de tipo 2v2 y falta1 con estado pending
  /// de una lista de clubes, ordenadas por fecha desde ahora en adelante.
  ///
  /// [clubIds]: Lista de IDs de clubes para filtrar.
  /// Retorna solo reservas con startTime >= ahora.
